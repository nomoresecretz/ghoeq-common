...
func (x *WorldApprove) Reset() {
	*x = WorldApprove{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_eqstruct_world_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WorldApprove) Descriptor() ([]byte, []int) {
	return file_proto_eqstruct_world_proto_rawDescGZIP(), []int{2}
}
...
var file_proto_eqstruct_world_proto_rawDesc = []byte{
	...
	0x73, 0x61, 0x67, 0x65, 0x22, 0x3e, 0x0a, 0x0c, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x41, 0x70, 0x70,
	0x72, 0x6f, 0x76, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
...
var file_proto_eqstruct_world_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_eqstruct_world_proto_goTypes = []interface{}{
	...
	(*WorldApprove)(nil), // 2: eqstruct.WorldApprove
}
...
func file_proto_eqstruct_world_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_eqstruct_world_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorldApprove); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
