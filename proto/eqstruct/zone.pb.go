...
func (x *ZoneChange) Reset() {
	*x = ZoneChange{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_eqstruct_zone_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ZoneChange) Descriptor() ([]byte, []int) {
	return file_proto_eqstruct_zone_proto_rawDescGZIP(), []int{8}
}
...
func (x *ZoneChangeReq) Reset() {
	*x = ZoneChangeReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_eqstruct_zone_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ZoneChangeReq) Descriptor() ([]byte, []int) {
	return file_proto_eqstruct_zone_proto_rawDescGZIP(), []int{9}
}
...
var file_proto_eqstruct_zone_proto_rawDesc = []byte{
	...
	,
	...
	0x7a, 0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x52, 0x01, 0x7a, 0x12, 0x18, 0x0a, 0x07, 0x68, 0x65,
	0x61, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x05, 0x20, 0x01, 0x28, 0x02, 0x52, 0x07, 0x68, 0x65, 0x61,
	0x64, 0x69, 0x6e, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68,
...
var file_proto_eqstruct_zone_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_proto_eqstruct_zone_proto_goTypes = []interface{}{
	...
	(*ZoneChange)(nil),      // 8: eqstruct.ZoneChange
	(*ZoneChangeReq)(nil),   // 9: eqstruct.ZoneChangeReq
}
...
func file_proto_eqstruct_zone_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_eqstruct_zone_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_eqstruct_zone_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ZoneChangeReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
